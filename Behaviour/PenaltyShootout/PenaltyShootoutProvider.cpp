...
#include "PenaltyInitialState.h"
#include "PenaltySetState.h"
#include "PenaltyPlayingState.h"
#include "PenaltyFinishedState.h"
 ...
 */
PenaltyShootoutProvider::PenaltyShootoutProvider(Behaviour* manager) : BehaviourFSMProvider(manager)
{
    m_initial = new PenaltyInitialState(this);
    m_set = new PenaltySetState(this);
    m_playing = new PenaltyPlayingState(this);
    m_finished = new PenaltyFinishedState(this);
    m_penalised = new PenaltyPenalisedState(this);
 ...
 */
PenaltyShootoutProvider::~PenaltyShootoutProvider()
{
    delete m_initial;
    delete m_set;
    delete m_playing;
 ...
 */
void PenaltyShootoutProvider::doBehaviourCommons()
{
 ...
 */
BehaviourState* PenaltyShootoutProvider::nextStateCommons()
{
