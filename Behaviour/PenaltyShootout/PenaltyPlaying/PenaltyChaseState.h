...
#ifndef PENALTY_CHASE_SOCCER_FSM_STATE_H
#define PENALTY_CHASE_SOCCER_FSM_STATE_H

#include "../PenaltyShootoutFSMState.h"
class PenaltyGoToBall;
class PenaltyFindTarget;
class PenaltyKick;

class PenaltyChaseState : public PenaltyShootoutFSMState
{
public:
    PenaltyChaseState(PenaltyShootoutFSMState* parent);
    ~PenaltyChaseState();
...
protected:
    PenaltyGoToBall* m_go_to_ball;
    PenaltyFindTarget* m_find_target;
    PenaltyKick* m_kick;
};
