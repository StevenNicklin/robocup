...
#ifndef PENALTY_BALL_IS_LOST_STATES_H
#define PENALTY_BALL_IS_LOST_STATES_H
...
class PenaltyBallIsLostSubState : public PenaltyShootoutState
{
public:
    PenaltyBallIsLostSubState(PenaltyBallIsLostState* parent) : PenaltyShootoutState(parent), m_lost_machine(parent) {};
    virtual ~PenaltyBallIsLostSubState() {};
protected:
    PenaltyBallIsLostState* m_lost_machine;
};
 ...
 */
class PenaltyBallIsLostPan : public PenaltyBallIsLostSubState
{
public:
    PenaltyBallIsLostPan(PenaltyBallIsLostState* parent) : PenaltyBallIsLostSubState(parent), m_ROTATIONAL_SPEED(0.1)
    {
        m_spin_speed = 0;
        m_time_in_state = 0;
        m_previous_time = 0;
 ...
 */
class PenaltyBallIsLostSpin : public PenaltyBallIsLostSubState
{
public:
    PenaltyBallIsLostSpin(PenaltyBallIsLostState* parent) : PenaltyBallIsLostSubState(parent), m_ROTATIONAL_SPEED(0.4)
    {
        m_spin_speed = m_ROTATIONAL_SPEED;
        m_time_in_state = 0;
        m_previous_time = 0;
    }
    ~PenaltyBallIsLostSpin() {};
protected:
    BehaviourState* nextState()
    {   // do state transitions in the ball is lost state machine
 ...
 */
class PenaltyBallIsLostMove : public PenaltyBallIsLostSubState
{
public:
    PenaltyBallIsLostMove(PenaltyBallIsLostState* parent) : PenaltyBallIsLostSubState(parent) {}
    ~PenaltyBallIsLostMove() {};
protected:
    BehaviourState* nextState()
    {   // do state transitions in the ball is lost state machine
        return this;
