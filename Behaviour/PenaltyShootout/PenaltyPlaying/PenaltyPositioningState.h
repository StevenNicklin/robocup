...
#ifndef PENALTY_POSITIONING_SOCCER_FSM_STATE_H
#define PENALTY_POSITIONING_SOCCER_FSM_STATE_H

#include "../PenaltyShootoutFSMState.h"
class GoToPosition;

class PenaltyPositioningState : public PenaltyShootoutFSMState
{
public:
    PenaltyPositioningState(PenaltyShootoutFSMState* parent);
    ~PenaltyPositioningState();
private:
