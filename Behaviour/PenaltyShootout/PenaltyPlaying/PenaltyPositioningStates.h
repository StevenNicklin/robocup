...
#ifndef PENALTY_POSITIONING_STATES_H
#define PENALTY_POSITIONING_STATES_H

#include "../PenaltyShootoutState.h"
class PenaltyShootoutFSMState;       // PositioningState is a SoccerFSMState
...
class GoToPosition : public PenaltyShootoutState
{
public:
    GoToPosition(PenaltyShootoutFSMState* parent) : PenaltyShootoutState(parent) {}
    ~GoToPosition() {};
protected:
