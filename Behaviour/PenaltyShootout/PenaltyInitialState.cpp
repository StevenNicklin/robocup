...
PenaltyInitialState::PenaltyInitialState(PenaltyShootoutProvider* provider) : PenaltyShootoutState(provider)
{
}

PenaltyInitialState::~PenaltyInitialState()
{
}

BehaviourState* PenaltyInitialState::nextState()
{
    return this;
}

void PenaltyInitialState::doState()
{
