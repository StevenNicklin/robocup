...
PenaltyFinishedState::PenaltyFinishedState(PenaltyShootoutProvider* provider) : PenaltyShootoutState(provider)
{
}

PenaltyFinishedState::~PenaltyFinishedState()
{
}

BehaviourState* PenaltyFinishedState::nextState()
{
    return this;
}

void PenaltyFinishedState::doState()
{
