...
class PenaltyShootoutFSMState : public BehaviourFSMState
{
public:
    virtual ~PenaltyShootoutFSMState() {};
...
protected:
    PenaltyShootoutFSMState(PenaltyShootoutProvider* provider) {m_provider = provider; m_parent = 0;};
    PenaltyShootoutFSMState(PenaltyShootoutFSMState* parent) {m_parent = parent; m_provider = parent->m_provider;};
